...
Для решения расхождения в API-ключе рекомендуем <a href="https://seller.wildberries.ru/service-desk-v2/requests/history">обратиться в поддержку wildberries</a>  (тему выберите: <b>"Ошибки в получаемой информации по API"</b>) и попросить их скорректировать данные в API-ключе вашего магазина.
